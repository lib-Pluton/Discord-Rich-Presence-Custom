...
buttons : [{label : "Application Name" , url : "Website Link"},{label : "Application Name", url : "Website link"}] // Example : "Application name = Github" "Website Link : https://github.com/lib-Pluton  
}
})
})
